...
def move_Back(indexValue):
     ...
     #status Bar
     statusBar=Label(rootVariable,text="Image "+str(indexValue+1)+" of "+str(len(imageList)),relief=SUNKEN)          # with relief=SUNKEN our yext appears to be ander ke tarf
                                                                                                        # with anchor we can set its direction
     statusBar.grid(row=2,column=1,sticky=W+E)
...
#Status Bar
statusBar=Label(rootVariable,text="Image 1"+" of "+str(len(imageList)),relief=SUNKEN)          # with relief=SUNKEN our yext appears to be ander ke tarf
                                                                                                        # with anchor we can set its direction
statusBar.grid(row=2,column=1,sticky=W+E)
